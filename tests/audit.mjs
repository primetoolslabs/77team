...
assert.ok(main.includes('serviceWorker.register("./service-worker.js?v=22.9.32-profilegame4")'));
assert.ok(html.includes('js/main.js?v=22.9.32-profilegame4'));
...
assert.ok(main.includes('service-worker.js?v=22.9.32-profilegame4'));
assert.ok(html.includes('js/main.js?v=22.9.32-profilegame4'));
const serviceWorker=read("service-worker.js");
assert.ok(serviceWorker.includes('77-team-manager-v22.9.32-profilegame4'));
assert.ok(serviceWorker.includes('js/main.js?v=22.9.32-profilegame4'));
