const CACHE_NAME="77-team-manager-v23.0.0";
const FIREBASE_SDK=[
...
const APP_SHELL=[
  "./","./index.html","./manifest.json","./css/style.css?v=23.0.0",
  "./js/ui.js?v=23.0.0","./js/main.js?v=23.0.0","./js/firebase-config.js","./js/pdf-generator.js?v=23.0.0",
