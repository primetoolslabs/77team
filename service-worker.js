const CACHE_NAME="77-team-manager-v22.9.32-characterrole1";
const FIREBASE_SDK=[
...
const APP_SHELL=[
  ...
  "./js/ui.js?v=22.9.32","./js/main.js?v=22.9.32-characterrole1","./js/firebase-config.js","./js/pdf-generator.js?v=22.9.32",
