const CACHE_NAME="77-team-manager-v22.9.27";
const FIREBASE_SDK=[
...
const APP_SHELL=[
  "./","./index.html","./manifest.json","./css/style.css?v=22.9.27",
  "./js/ui.js?v=22.9.27","./js/main.js?v=22.9.27","./js/firebase-config.js","./js/pdf-generator.js?v=22.9.27",
