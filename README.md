...
`o e-mail escolhido no primeiro acesso`
...
## Proprietário sem e-mail fixo

O primeiro usuário que concluir o fluxo **Primeiro acesso** se torna o
proprietário definitivo. Depois disso, `system/owner` impede uma segunda criação.

Por segurança, faça o primeiro acesso logo após publicar o site.
