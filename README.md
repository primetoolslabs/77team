...
- o Proprietário pode promover e rebaixar contas vinculadas na aba Membros;
- Staff não pode promover outras pessoas para Staff;
- o cadastro manual impede a criação de Staff sem conta de login;
- cargos antigos vinculados são sincronizados automaticamente pelo Proprietário.
...
# Versão 13.1 — Rodapé simplificado

Alterações:

- removido completamente o card do usuário no rodapé do menu lateral;
- mantido somente o botão Sair;
- informações do usuário continuam disponíveis no cabeçalho superior;
- nenhuma função principal do sistema foi alterada.


# V13.1 corrigida

- removida a imagem da logo do menu lateral;
- mantido apenas 77 TEAM e PAINEL DE CONTROLE;
- sidebar fixada à esquerda;
- cabeçalho reposicionado no topo;
- conteúdo alinhado ao lado da sidebar;
- removido o grande espaço vazio;
- apenas a área principal possui rolagem;
- botão Sair permanece no rodapé;
