...
# Versão 12.0 — Enterprise Dashboard

A Visão Geral foi redesenhada com:

- quatro indicadores premium;
- presenças recentes;
- Top 5 ranking;
- eventos do dia;
- gráfico semanal;
...
- atividade recente;
- lista de membros com Level e XP;
- status do sistema.

Todas as informações são alimentadas pelos dados já carregados do Firebase.
As demais páginas e regras da V11 foram preservadas.
