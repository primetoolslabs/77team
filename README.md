# 77 TEAM Manager V15.1 — Revisão de estabilidade
...
- Permissões de Proprietário, Staff e Membro.
...
- PRESENÇAS: disponível apenas para Proprietário e Staff.
- GESTÃO: disponível apenas para Proprietário e Staff.
- ADMINISTRAÇÃO: disponível exclusivamente para o Proprietário.
