...
- Somente usuários não DEV são desconectados quando a manutenção é ativada.
- Regras do Firestore atualizadas para reconhecer contas DEV antigas e atuais.
- Corrigida a condição de corrida durante a sincronização do status de manutenção.
