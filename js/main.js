...
const state={user:null,profile:null,guest:false,members:[],attendance:[],users:[],audit:[],events:[],notifications:[],sentNotifications:[],notificationReads:[],settings:{},xpLogs:[],supportMessages:[],selectedSupportOwnerUid:"",selectedSupportTicketId:"",supportView:"active",unsubs:[]};
...
async function sendSupportMessage({ownerUid,ownerName,text,link,file,ticketId}){
  const cleanText=(text||"").trim(); if(!cleanText)throw new Error("Digite uma mensagem.");
