...
function renderPresence(targetId,kind){
  ...
  target.innerHTML=`<div class="presence-command" data-presence-root="${kind}">
    ...
    ${editor()?`<div class="presence-actions"><button class="btn primary" data-presence-bulk="1" data-kind="${kind}">✓ Marcar presentes</button><button class="btn" data-presence-bulk="-1" data-kind="${kind}">× Marcar ausentes</button><button class="btn" data-presence-bulk="0" data-kind="${kind}">Limpar marcações</button><button class="btn" data-presence-review="${kind}">✅ Finalizar Presença</button></div>`:""}
...
function render(){
  ...
  renderPresence("worldbossContent","worldboss");renderPresence("purgatorioContent","purgatorio");renderPresence("eventosContent","eventos");renderRtPresence();
