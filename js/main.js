...
const state={user:null,profile:null,guest:false,members:[],attendance:[],users:[],audit:[],events:[],notifications:[],settings:{},xpLogs:[],unsubs:[]};
...
const STAFF_ONLY_PAGES=new Set(["worldboss","purgatorio","eventos","personagens","metas","solicitacoes"]);
...
on("staffNoticeForm","submit",async event=>{
  ...
  try{
    await addDoc(collection(db,"notifications"),{
      title,
      message,
      audience:byId("staffNoticeAudience")?.value||"all",
