...
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=22.9.32-menudrop1").catch(error=>console.warn("Service Worker indisponível:",error)));
