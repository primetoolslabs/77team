...
if("serviceWorker" in navigator)window.addEventListener("load",()=>navigator.serviceWorker.register("./service-worker.js?v=22.9.32-profilegame4").catch(error=>console.warn("Service Worker indisponível:",error)));
