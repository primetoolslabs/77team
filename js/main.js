...
const STAFF_ONLY_PAGES=new Set(["registros","worldboss","purgatorio","eventos","personagens","metas","solicitacoes","notificacoes","atendimento","chat"]);
...
function applyRestrictedVisibility(){
  ...
  ["presencas","registros"].forEach(page=>{
    const section=byId(page);
    if(section)section.classList.toggle("hidden",!allowed);
  });

  document.querySelectorAll('[data-page="presencas"],[data-page="registros"]')
