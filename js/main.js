...
function render(){
  ...
  renderNotifications();renderCalendar();renderStatistics();updatePdfMemberOptions();renderOwnProfile();renderCharacterProfile();renderCharactersTable();renderCharacterCenter();renderHistoryCenter();applyRestrictedVisibility();
}
...
on("profileNicknameForm","submit",async event=>{
  ...
  try{
    ...
    state.profile.name=name;applyPermissions();renderOwnProfile();renderCharacterProfile();renderCharactersTable();renderCharacterCenter();renderHistoryCenter();applyRestrictedVisibility();toast("Nickname atualizado.");
...
on("profileAvatarForm","submit",async event=>{
  ...
  try{
    ...
    renderOwnProfile();renderCharacterProfile();renderCharactersTable();renderCharacterCenter();renderHistoryCenter();applyRestrictedVisibility();
    applyPermissions();
    event.target.reset();
...
on("removeProfileAvatar","click",async()=>{
  try{
    ...
    state.profile.avatarDataUrl="";renderOwnProfile();renderCharacterProfile();renderCharactersTable();renderCharacterCenter();renderHistoryCenter();applyRestrictedVisibility();toast("Avatar removido.");
